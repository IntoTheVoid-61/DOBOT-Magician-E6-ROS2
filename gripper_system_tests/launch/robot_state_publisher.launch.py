...
""" 
This Launch file handles the launching of RVIZ visualization of the gripper.
...
def generate_launch_description():
    ...
    # Define file names
    urdf_package = 'gripper_system_tests' # package containing robot description
    urdf_filename = 'gripper.urdf.xacro' # top-level xacro file
    rviz_filename = 'gripper_description.rviz'
