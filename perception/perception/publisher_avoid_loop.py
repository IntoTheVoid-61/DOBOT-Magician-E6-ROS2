...
class YoloImagePublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("lower_green", [0, 36, 6]) # H-min, S-min, V_min
        self.declare_parameter("upper_green", [179, 255, 133]) # H_max S_max V_max
        ...
        self.max_weed_area = 50000 #10000
