...
from dobot_msgs_fb.srv import RemoveWeed
...
class YoloImagePublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("lower_green", [16, 34, 95]) # H-min, S-min, V_min
        self.declare_parameter("upper_green", [105, 213, 200]) # H_max S_max V_max
        ...
        self.srv = self.create_service(
            RemoveWeed, "remove_weed", self.service_callback
        )
    ...
    def service_callback(self,request,response):
        ...
        # if weeds not detected response->false
            ...
            response.weed_y = 0.0
            response.weed_z = 0.0
            response.weed_height = 0.0
            response.weed_radius = 0.0
            return response
